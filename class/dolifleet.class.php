...
class doliFleet extends SeedObject
{
	/**
	 * Canceled status
	 */
	...
	public static $TStatus = array(
		self::STATUS_CANCELED => 'doliFleetStatusShortCanceled'
		,self::STATUS_DRAFT => 'doliFleetStatusShortDraft'
		,self::STATUS_VALIDATED => 'doliFleetStatusShortValidated'
	//      ,self::STATUS_REFUSED => 'doliFleetStatusShortRefused'
	//      ,self::STATUS_ACCEPTED => 'doliFleetStatusShortAccepted'
	);

	/** @var string $table_element Table name in SQL */
	public $table_element = 'dolifleet';

	/** @var string $element Name of the element (tip for better integration in Dolibarr: this value should be the reflection of the class name with ucfirst() function) */
	public $element = 'dolifleet';
	...
	public function getNomUrl($withpicto = 0, $moreparams = '')
	{
		...
		$result='';
		$label = '<u>' . $langs->trans("ShowdoliFleet") . '</u>';
	...
	public static function LibStatut($status, $mode)
	{
		...
		if ($status==self::STATUS_CANCELED) { $statusType='status9'; $statusLabel=$langs->trans('doliFleetStatusCancel'); $statusLabelShort=$langs->trans('doliFleetStatusShortCancel'); } elseif ($status==self::STATUS_DRAFT) { $statusType='status0'; $statusLabel=$langs->trans('doliFleetStatusDraft'); $statusLabelShort=$langs->trans('doliFleetStatusShortDraft'); } elseif ($status==self::STATUS_VALIDATED) { $statusType='status1'; $statusLabel=$langs->trans('doliFleetStatusValidated'); $statusLabelShort=$langs->trans('doliFleetStatusShortValidate'); } elseif ($status==self::STATUS_REFUSED) { $statusType='status5'; $statusLabel=$langs->trans('doliFleetStatusRefused'); $statusLabelShort=$langs->trans('doliFleetStatusShortRefused'); } elseif ($status==self::STATUS_ACCEPTED) { $statusType='status6'; $statusLabel=$langs->trans('doliFleetStatusAccepted'); $statusLabelShort=$langs->trans('doliFleetStatusShortAccepted'); }
...
//class doliFleetDet extends SeedObject
//{
//    public $table_element = 'dolifleetdet';
//
//    public $element = 'dolifleetdet';
//
//
//    /**
//     * doliFleetDet constructor.
//     * @param DoliDB    $db    Database connector
//     */
//    public function __construct($db)
//    {
